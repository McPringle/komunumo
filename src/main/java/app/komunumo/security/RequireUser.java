...
/**
 * <p>Composed security annotation that requires the caller to have the {@code USER} role.</p>
 *
 * <p>Under Spring Security's default role prefixing, {@code hasRole('USER')} checks for the
 * {@code ROLE_USER} authority on the current {@link org.springframework.security.core.Authentication}.</p>
 *
