...
('about', 'EN', NOW(), NOW(), 'About',
 'Are you a community leader? *Komunumo* makes your life a lot easier! Everything you need to run your community in one place – for free!
 *Komunumo* is an open source community management software that helps you with all tasks of managing a community, such as a user group.
 ...
 *Komunumo* is free software licensed under the [GNU Affero General Public License (AGPL)](https://www.gnu.org/licenses/agpl-3.0.html). It is developed by a passionate [group of people](https://github.com/McPringle/komunumo/blob/main/CONTRIBUTORS.md) who actively contribute to various communities in their free time. No one earns money with *Komunumo*. *Komunumo* belongs to the community!
 ...
 Development happens in our [GitHub repository](https://github.com/McPringle/komunumo), where we [track issues](https://github.com/McPringle/komunumo/issues) and host a [forum for discussions and support](https://github.com/McPringle/komunumo/discussions).
...
('about', 'DE', NOW(), NOW(), 'Über',
 'Du leitest eine Community? *Komunumo* macht dir das Leben leichter! Alles, was du für deine Community brauchst – an einem Ort, kostenlos!
 *Komunumo* ist eine quelloffene Software zur Community-Verwaltung, die dich bei allen Aufgaben unterstützt – etwa bei der Organisation einer User Group.
